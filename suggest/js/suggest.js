/**
css示例:
.suggest-list {margin:0;padding:0;border:1px solid #ddd;background:#fff;line-height:20px;font-size:14px;list-style: none;}
.suggest-list li {padding:2px 5px;border-bottom:1px solid #ddd;cursor:default;zoom:1}
.suggest-item-even {background:#EEE}
.suggest-item-odd {background:#DDD}
.suggest-curr-item {background:#7FAAE4; color:#fff;}
*/
(function($){
	/**
